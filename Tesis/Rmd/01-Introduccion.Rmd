...
#### Carcterización del movimiento sísmico {.unnumbered}
...
#### Respuesta del Sitio {.unnumbered}
...
#### Ergodicidad y Homocedasticidad {.unnumbered}
...
#### Selección de Sismos {.unnumbered}
...
#### Capítulo IV: ARMA/Dynamic Models  {.unnumbered}

El capítulo IV trata sobre la parametrización de las series temporales asociadas a cada evento sísmico. El objetivo principal de este capítulo será identificación de los parámetros asociados a un modelo dinámico equivalente $\psi = \{ \psi_1,\psi_2,... \}$ mediante el análisis paramétrico de series temporales no-estacionarias en roca basal. Esta es la etapa define uno de los aportes más importantes del trabajo, ya que establece una representación paramétrica de los registros sísmicos regularizados y normalizados en roca basal

#### Capítulo IV:  Clustering \*\* corregir {.unnumbered}
...
#### Capítulo V: \*\*corregir {.unnumbered}
